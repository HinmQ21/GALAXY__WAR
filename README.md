...
## 2. Cách mở project
- 2_1. Tải [VSCode](https://code.visualstudio.com/download) và [git](https://git-scm.com/downloads)
...
- 2_3. Các bạn có thể down file zip về máy rồi giải nén, hoặc có thể tạo ra 1 folder mới rồi dùng lệnh git clone + link repo để clone về: [How to clone repo](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
